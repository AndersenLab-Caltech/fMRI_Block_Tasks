...
expName = 'fMRI_Blocked_Grasp'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\lydia\\Documents\\Code\\PsychoPy\\fMRI block tasks\\fMRI_Blocked_Reach_design_lastrun.py',
