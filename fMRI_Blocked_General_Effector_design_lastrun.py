...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\AndersenLab\\Desktop\\fMRI_Block_Tasks\\fMRI_Blocked_General_Effector_design_lastrun.py',
...
def setupWindow(expInfo=None, win=None):
    ...
    if win is None:
        ...
        win = visual.Window(
            ...
            monitor='UHK4K', color=[-1.0000, -1.0000, -1.0000], colorSpace='rgb',
